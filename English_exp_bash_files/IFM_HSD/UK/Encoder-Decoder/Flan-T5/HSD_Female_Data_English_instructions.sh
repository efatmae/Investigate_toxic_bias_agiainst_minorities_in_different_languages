export DATASET=../../../../../Dataset_Creation/Dataset_for_Logliklihood/Final_SOS_data_in_different_languages/UK_SOS_female_data.csv
export MODEL_NAME=flan-t5-base
export MODEL_NAME_OR_PATH=google/flan-t5-base
export INST_LANGUAGE=e
export MODEL_QUANTZ=yes
export OUTPUT_PATH=../../../../../Results/generative_models_HSL/English_LMs/UK/Encoder-Decoder/Flan-T5/Female_IFM_HSD_Flan_English_instructions.csv
