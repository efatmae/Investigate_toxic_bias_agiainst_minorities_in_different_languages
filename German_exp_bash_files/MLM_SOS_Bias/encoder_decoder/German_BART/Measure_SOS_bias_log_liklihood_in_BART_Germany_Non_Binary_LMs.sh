...
export MODEL_NAME_OR_PATH=Shahm/bart-german
export OUTPUT_PATH=../../../../Results/Log-Likihood/German_LMs/encoder_decoder/German_BART/Germany_SOS_Non_Binary_BART.csv
