...
# Example usage
file_path = "Egyptian_arabic_HONEST_non_binary.csv"  # Replace with your file path
column_name = "bias_type"  # Replace with your column name
output_file_path = "Egyptian_arabic_HONEST_non_binary.csv"  # Replace with the desired output file path
